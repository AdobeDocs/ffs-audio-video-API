...
[Review the Getting Started page](../../getting-started/index.md) for authentication and setup.
...
-  `avatarId` with the unique ID of the avatar to be used for avatar generation. Users should [refer to the GET Avatars API](../../api/index.md) to choose the Avatar ID or refer to the [Avatar Catalog](../../getting-started/avatar-catalog/index.md) to see the list of avatars.
-  `voiceId` with the unique ID of the voice to be used for avatar generation. Users should [refer to the GET Voices API](../../api/index.md) to choose the Voice ID.
...
[Refer to the Technical Usage notes](/getting-started/usage/index.md) to understand the supported formats, aspect ratio, etc. for video and image backgrounds.
